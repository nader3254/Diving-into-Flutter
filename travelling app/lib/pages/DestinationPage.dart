...
class _DestinationScreenState extends State<Destinationpage> {
  ...
  Widget HotelTxt(Activity activity)
  {
    return  Container(
      margin: EdgeInsets.fromLTRB(15.0, 5.0, 10.0, 3.0),
      height: 180.0,
      width: 10000,
      decoration: BoxDecoration(
      ...
      child: Padding(
        padding:const EdgeInsets.fromLTRB(120.0, 20.0, 10.0, 20.0),
        child: Column(
